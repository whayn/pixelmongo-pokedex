...
module.exports = {
    ...
    async execute({ client, interaction }) {
        try {
            ...
            if (!pokemons[0])
                return interaction.editReply(notifier_1.Notifier.error("Le nom d'item entré est invalide (ex: minecraft:dirt)"));
            ...
            if (!formatedPokemons[0].drop)
                return interaction.editReply(notifier_1.Notifier.error("Le nom d'item entré est invalide (ex: minecraft:dirt)"));
            const researchResultsEmbed = (0, utils_1.createSearchResult)(formatedPokemons, ressource, client);
